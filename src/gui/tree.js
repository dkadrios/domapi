...
domapi.comps.tree.pathExists = function(path,del){
  return this._walkPath(path,del,false);
};
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
domapi.comps.tree.expandPath = function(path,del){
  return this._walkPath(path,del,true);
};
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
domapi.comps.tree._walkPath = function(path,del,openit){
  del  = domapi.rVal(del,this.delimiter);
  path = path.split(del);
  var a,b,found,s;
  var n = this;
...
domapi.comps.tree._loadFromJson = function(j,rootNode){
  try{
    var nodes = j.nodes;if(!nodes)return false;
...
domapi.comps.tree.ondragallow = function(arg){
  ...
  var canDrag = p != e && p.doAllowDrag && e.doAllowNodeDrag;
  return canDrag;
};
//------------------------------------------------------------------------------

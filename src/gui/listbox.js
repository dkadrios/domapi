...
domapi._private.listbox.domouseover = function(E){
  ...
  var t = domapi.theme;
  var f = t.fonts;
  if(!r.doRollover || !r.enabled || domapi.customDrag.inDrag)return;
...
domapi._private.listbox.domouseout = function(E){
  ...
  var t = domapi.theme;
  var f = t.fonts;
  if(!r.enabled || !r.doRollover || domapi.customDrag.inDrag)return;
  var e = domapi.findTarget(E,"LISTBOXITEM");if(!e||e==r)return;
...
domapi._private.listbox.domousedown = function(E){
  var r = domapi.findTarget(E,"LISTBOX");
  if(!r.enabled || !r.doDepress || domapi.customDrag.inDrag)return;
  var e=domapi.findTarget(E,"LISTBOXITEM");if(!e||e==r)return;
  r.setBorderIn(e);
};
//------------------------------------------------------------------------------
...
domapi._private.listbox.doclick = function(E){
  ...
  if(!e || e==r || !r.enabled || domapi.customDrag.inDrag)return;
...
domapi._private.listbox.dokeydown = function(E){
  ...
  if(!r._inedit){
    ...
    if(k == 40 && r.itemIndex<r.items.length-1){// DOWN
      if((!(shiftKey || ctrlKey) && r.doMultiSelect) || !r.doMultiSelect)
        if(r.onbeforechange && r.onbeforechange(r.items[r.itemIndex+1]))r.selectNone();
      r.itemIndex++;
      r.selectItem(r.itemIndex, true);
    ...
    if(k == 27){r.selectNone();r.selectItem(r.itemIndex, true);} // ESC
    if(k >= 48){// && k <= 122) { //alpha & numeric characters (by Chris Lamothe)
      var temp = "";
      var hit = false;
      var reassign = false;
      var startIndex = 0;
...
domapi.comps.listbox.onallowinsertabove = function(arg){
  ...
  return (e/* && e.previousSibling != null*/);
};
//------------------------------------------------------------------------------

...
domapi.Skin = function(nm){
  ...
  //----------
  this.shim       = new Image();this.shim.src       = domapi.themePath + "shim.gif";
  this.buttonface = new Image();this.buttonface.src = this.path        + "buttonface.gif";
  this.shadow     = new Image();this.shadow.src     = this.path        + "shadow.png";
  //----------
...
domapi.Theme.prototype.postDefaults.listgrid = function(arg){
  ...
  domapi._assert(arg, "paddingLeft",        0 );
  domapi._assert(arg, "paddingRight",       0 );
  domapi._assert(arg, "paddingTop",         0 );//t.skin.metrics.headerbar.h);
  domapi._assert(arg, "paddingBottom",      0 );
...
//------------------------------------------------------------------------------
domapi.Theme.prototype.postDefaults.splitpane = function(arg){
